Maximum Subarray Sum → contiguous elements (Kadane's Algorithm)
Maximum Subsequence Sum → any elements (sum of positives)
...
Maximum Subsequence
If positives exist → sum all positives
If all negative → pick maximum element
